...
if ( !function_exists( 'eedee_gutenslider_block_assets' ) ) {
    ...
    function eedee_gutenslider_block_assets()
    {
        ...
        // wp_register_style(
        // 	'eedee-gutenslider-slick-css', // Handle.
        // 	plugins_url( 'src/vendor/slick/slick.css', dirname( __FILE__ ) ), // Block style CSS.
        // 	array(), // Dependency to include the CSS after it.
        // 	filemtime( plugin_dir_path( __DIR__ ) . 'src/vendor/slick/slick.css' ) // Version: File modification time.
        // );
        //
        // wp_register_style(
        // 	'eedee-gutenslider-slick-theme-css', // Handle.
        // 	plugins_url( 'src/vendor/slick/slick-theme.css', dirname( __FILE__ ) ), // Block style CSS.
        // 	array(), // Dependency to include the CSS after it.
        // 	filemtime( plugin_dir_path( __DIR__ ) . 'src/vendor/slick/slick-theme.css' ) // Version: File modification time.
        // );
        wp_register_script(
            'eedee-gutenslider-slick-js',
            plugins_url( '/src/vendor/slick/slick.min.js', dirname( __FILE__ ) ),
            array( 'jquery' ),
            filemtime( plugin_dir_path( __DIR__ ) . '/src/vendor/slick/slick.js' ),
            true
        );
        wp_register_script(
        ...
        if ( function_exists( 'register_block_type' ) ) {
            register_block_type( 'eedee/block-gutenslider', array(
                ...
                'style'           => [ 'eedee-gutenslider-style-css', 'dashicons' ],
                'script'          => $scripts,
...
// if ( ! function_exists( 'eedee_custom_pricing_js_path' ) ) {
// 	function eedee_custom_pricing_js_path( $default_pricing_js_path ) {
// 			return dirname( dirname( plugin_basename( __FILE__ ) ) ) . '/freemius-pricing/freemius-pricing.js';
// 	}
// }
//
// gutenslider_fs()->add_filter( 'freemius_pricing_js_path', 'eedee_custom_pricing_js_path' );
