...
function wds_onload() {
  ...
  jQuery('.wds_pp_butt_groups').each(function(i) {
    var pp_type_key = jQuery(this).val();
  if( typeof wds_pp_butt_type[pp_type_key] !== "undefined" && typeof wds_pp_butt_type[pp_type_key]["type_name"] !== "undefined" ) {
  ...
  jQuery('.wds_pp_butt_col_groups').each(function(i) {
    var pp_color_key = jQuery(this).val();
  ...
  jQuery('.wds_bull_butt_groups').each(function(i) {
    bull_type_key = jQuery(this).val();
  if( typeof wds_blt_img_type[bull_type_key] !== "undefined" && typeof wds_blt_img_type[bull_type_key]["type_name"] !== "undefined" ) {
  ...
  jQuery('.wds_bull_butt_col_groups').each(function(i) {
    bull_color_key = jQuery(this).val();
